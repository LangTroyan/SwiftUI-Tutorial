...
//
//  Created by Dylan Trujillo on 09/11/2020.
//
...
//                .offset(y: -300)
            ...
            BottomCardView(show: $showCard)
                .offset(x: 0, y: showCard ? 600 : 1000)
                ...
                .gesture(
                    DragGesture().onChanged { value in
                        ...
                        self.bottomState.height += self.showFull ? -600 : 0
                        if self.bottomState.height < -600 {
                    ...
                    .onEnded { value in
                        ...
                        if (self.bottomState.height < -100 && !self.showFull) || (self.bottomState.height < -500 && self.showFull){
                            self.bottomState.height = -600
                            self.showFull = true
                        }
                        else {
